...
export default function Organs() {
  return (
    <div className="page">
      ...
      <ul>
        <li>
          <a href="#low1">Organ#1</a>
        </li>
        <li>
          <a href="low2">Organ#2</a>
        </li>
        <li>
          <a href="#low3">Organ#3</a>
        </li>
      </ul>
      <p id="low1">
        <b>Organ1</b> ipsum dolor sit amet consectetur, adipisicing elit.
      ...
      <p id="low2">
        <b>Organ2</b> ipsum dolor sit amet consectetur, adipisicing
      ...
      <p id="low3">
        <b>Organ3</b> ipsum dolor sit amet consectetur, adipisicing
        elit. Neque vero corrupti odit? Accusamus quisquam eaque inventore ab
        consectetur, repellendus facilis in, fugiat sed, cum dolor officia porro
        saepe eveniet corporis. Asperiores sequi omnis id sapiente hic earum.
        Iusto rerum reiciendis libero at expedita, quisquam dolor quia accusamus
